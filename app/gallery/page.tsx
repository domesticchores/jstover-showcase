...
export default function GalleryPage() {
  return <div className='bg-gradient-to-r from-slate-100 to-slate-200 overflow-x-hidden'>
    ...
    <div className="flex w-screen justify-center pt-12 pb-8">
      <Image src={headerImg} alt='header' style={{width:'100%', height:'40vh'}}></Image>
